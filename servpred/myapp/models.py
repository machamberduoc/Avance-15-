...
class Servers(models.Model):
    ...
    freemegabytes = models.DecimalField(max_digits=12, decimal_places=2)
...
class Monitor(models.Model):
    ...
    freemegabytesm = models.DecimalField(max_digits=12, decimal_places=2)
...
class DataAnalytic(models.Model):
    ...
    freemegabytesd = models.DecimalField(max_digits=12, decimal_places=2)
    usedbytesd = models.DecimalField(max_digits=5, decimal_places=2)
    freebytesd = models.DecimalField(max_digits=5, decimal_places=2)
