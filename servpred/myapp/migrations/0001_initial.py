    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('freemegabytesd', models.DecimalField(decimal_places=2, max_digits=12)),
                ('usedbytesd', models.DecimalField(decimal_places=2, max_digits=5)),
                ('freebytesd', models.DecimalField(decimal_places=2, max_digits=5)),
            ],
        ),
        migrations.CreateModel(
            name='Monitor',
            fields=[
                ...
                ('freemegabytesm', models.DecimalField(decimal_places=2, max_digits=12)),
            ],
        ),
        migrations.CreateModel(
            name='Recomendations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('freemegabytes', models.DecimalField(decimal_places=2, max_digits=12)),
